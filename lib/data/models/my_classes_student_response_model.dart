...
MyClassesStudentResponse myClassesStudentResponseFromJson(String str) => MyClassesStudentResponse.fromJson(json.decode(str));

String myClassesStudentResponseToJson(MyClassesStudentResponse data) => json.encode(data.toJson());

class MyClassesStudentResponse {
  List<ClassesData> upcoming;
  List<ClassesData> cancelled;
  List<ClassesData> confirmed;

  MyClassesStudentResponse({
    required this.upcoming,
    required this.cancelled,
    required this.confirmed,
  });

  factory MyClassesStudentResponse.fromJson(Map<String, dynamic> json) => MyClassesStudentResponse(
