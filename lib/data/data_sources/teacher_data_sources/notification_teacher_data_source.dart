...
abstract class NotificationTeacherDataSource {
  Future<NotificationResponse> getNotifications(
      {required int userId, });
}

class NotificationTeacherDataSourceImpl extends NotificationTeacherDataSource {
  NotificationTeacherDataSourceImpl() : _restClient = GetIt.instance<ApiService>();
  ...
  Future<NotificationResponse> getNotifications({required int userId,}) async{
    final result =
    await _restClient.get(Endpoints.notification + '/$userId/Teacher', queryParameters: {
