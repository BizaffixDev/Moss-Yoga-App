...
import 'package:moss_yoga/presentation/providers/notification_providers/notification_teacher_provider.dart';
...
import '../../students_screens/notification_screen/notification_student_states.dart';
import 'notification_teacher_states.dart';


class NotificationTeacherScreen extends ConsumerStatefulWidget {
  const NotificationTeacherScreen({super.key});

  @override
  ConsumerState<NotificationTeacherScreen> createState() => _NotifyScreenFillState();
}

class _NotifyScreenFillState extends ConsumerState<NotificationTeacherScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await ref.read(notificationTeacherNotifierProvider.notifier)
          .getNotifications();
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<NotifictionTeachersStates>(notificationTeacherNotifierProvider, (previous, screenState) async {

      if (screenState is NotifictionTeacherSuccessfulState) {
      ...
      else if (screenState is NotifictionTeacherErrorState) {
      ...
      else if (screenState is NotifictionTeacherLoadingState) {
        debugPrint('Loading');
        showLoading(context);
        // setState(() {});
      }
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Today",style: manropeHeadingTextStyle.copyWith(
