...
class StudentChangePassword extends ConsumerStatefulWidget {
  // String email;
  ...
  @override
  ConsumerState<StudentChangePassword> createState() =>
      _StudentChangePasswordState();
}

class _StudentChangePasswordState extends ConsumerState<StudentChangePassword> {
...
*/
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<StudentAccountStates>(studentAccountNotifierProvider, (previous, screenState) async {
      ...
      if (screenState is StudentChangePasswordSuccessfulState) {
      ...
      else if (screenState is StudentChangePasswordErrorState) {
      ...
      else if (screenState is  StudentChangePasswordLoadingState) {
        debugPrint('Loading');
        showLoading(context);
        // setState(() {});
      }
    ...
    String userEmail =  ref.watch(emailProvider.notifier).state;
                        ...
                        CustomButton(
                          ...
                          onTap: () async {
                            ...
                            if(_currentPassController.text.isEmpty || _newPassController.text.isEmpty || _confirmPassController.text.isEmpty){
                              ...
                              await ref
                                  .read(studentAccountNotifierProvider
                                  .notifier)
                                  .changePassword(
                                email: userEmail,
