...
class StudentMyAccount extends StatefulWidget {
  const StudentMyAccount({super.key});

  @override
  State<StudentMyAccount> createState() => _StudentMyAccountState();
}

class _StudentMyAccountState extends State<StudentMyAccount> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                ArrowContainer(title: "Change Password", icon: HeroIcons.key, onTap: (){
                  context.push(PagePath.studentChangePassword);
                }),
                ...
                ArrowContainer(title: "Delete Account", icon: HeroIcons.trash, onTap: (){
                  context.push(PagePath.studentDeleteAccount);
