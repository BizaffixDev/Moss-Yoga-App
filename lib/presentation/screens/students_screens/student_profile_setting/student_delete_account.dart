...
class StudentDeleteAccount extends ConsumerStatefulWidget {
  const StudentDeleteAccount({super.key});

  @override
  ConsumerState<StudentDeleteAccount> createState() => _StudentDeleteAccountState();
}

class _StudentDeleteAccountState extends ConsumerState<StudentDeleteAccount> {
  ...
  void didChangeDependencies() {
    ...
    if (!_apiCalled) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        ...
        await ref.read(studentAccountNotifierProvider.notifier).getStudentData();
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<StudentAccountStates>(studentAccountNotifierProvider, (previous, screenState) async {

      if (screenState is StudentDeleteAccountSuccessfulState) {
      ...
      else if (screenState is StudentDeleteAccountErrorState) {
      ...
      else if (screenState is  StudentDeleteAccountLoadingState) {
        debugPrint('Loading');
        showLoading(context);
        // setState(() {});
      }
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          InkWell(
                                            ...
                                            onTap: (){
                                              ref.read(studentAccountNotifierProvider.notifier).deleteAccount(userId: userId);
                                            },
                                          )
                                        ],
                                      ),
