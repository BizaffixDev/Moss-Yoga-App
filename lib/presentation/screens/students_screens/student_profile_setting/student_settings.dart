...
class _StudentSettingsState extends ConsumerState<StudentSettings> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.watch(studentObjectProvider.notifier).state;
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                         ...
                         Text(
                           ref.watch(studentObjectProvider).username,
                         ...
                         Text(
                           ref.watch(studentObjectProvider).email,
                          style: const TextStyle(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ToggleContainer(title: "Location", icon: HeroIcons.mapPin, isSwitched: _locationSwitch,),
                              ...
                              //ArrowContainer(title: "Payment Method", icon: HeroIcons.currencyDollar, onTap: (){}),
                             const  SizedBox(
                                height: 20,
                              ),
                              const Text(
                              ...
                              ToggleContainer(title: "Notification", icon: HeroIcons.bell, isSwitched: _notificationSwitch,),
                              const SizedBox(
                                height: 20,
                              ),


                              ArrowContainer(title: "My Account", icon: HeroIcons.user, onTap: (){
                                context.push(PagePath.studentMyAccount);
                              }),
                            ],
                          ),
                        ),
