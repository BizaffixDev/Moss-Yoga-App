...
class StylesAllScreen extends ConsumerStatefulWidget {
  const StylesAllScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<StylesAllScreen> createState() => _StylesAllScreenState();
}

class _StylesAllScreenState extends ConsumerState<StylesAllScreen> {
