...
class TopDetailSectionReschedule extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TopDetailSectionReschedule> createState() => _TopDetailSectionRescheduleState();
}

class _TopDetailSectionRescheduleState extends ConsumerState<TopDetailSectionReschedule> {
  @override
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text("1.0",style: manropeSubTitleTextStyle.copyWith(
                                fontSize: 18.sp,
                                color: Colors.white,
                              ),)
                            ],
